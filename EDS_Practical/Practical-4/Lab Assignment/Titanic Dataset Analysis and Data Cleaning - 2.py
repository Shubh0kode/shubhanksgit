...
# 1. Create a new column 'IsAlone' which is 1 if the passenger is alone

# 2. Convert 'Sex' column to numeric values (male: 0, female: 1)
...
print(data['Survived'].value_counts().sort_index())
